    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.DELETE,"/api-carsi-shop/pago/deleteMetodoPago").hasAnyAuthority(Role.ADMIN.name(), Role.COMPRADOR.name(), Role.VENDEDOR.name())
                        ...
                        .requestMatchers(HttpMethod.POST,"/api-carsi-shop/pago/marcar-como-entregado").hasAnyAuthority(Role.ADMIN.name(), Role.COMPRADOR.name(), Role.VENDEDOR.name())
                        .requestMatchers(HttpMethod.POST,"/api-carsi-shop/pago//marcar-como-devuelto").hasAnyAuthority(Role.ADMIN.name(), Role.COMPRADOR.name(), Role.VENDEDOR.name())
                        ...
                        .requestMatchers(HttpMethod.POST,"/api-carsi-shop/comentarios/insert").hasAnyAuthority(Role.ADMIN.name(), Role.COMPRADOR.name(), Role.VENDEDOR.name())
                        .requestMatchers(HttpMethod.GET,"/api-carsi-shop/comentarios/carrito").hasAnyAuthority(Role.ADMIN.name(), Role.COMPRADOR.name(), Role.VENDEDOR.name())
                        .requestMatchers(HttpMethod.GET,"/api-carsi-shop/comentarios/usuario").hasAnyAuthority(Role.ADMIN.name(), Role.COMPRADOR.name(), Role.VENDEDOR.name())



                        .requestMatchers( "/api-carsi-shop/twilio/**" ).permitAll()
